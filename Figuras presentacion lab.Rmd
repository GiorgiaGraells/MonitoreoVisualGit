...
I <-ggplot(ComportamientoInv) + 
  ...
  scale_fill_manual(aesthetics = "fill", values = c('#a6cee3','#1f78b4','#33a02c','#e31a1c','#fdbf6f','#ff7f00'), name="Bird behavior") +ggtitle("Invierno")
...
P <-ggplot(ComportamientoPrim) + 
  ...
  scale_fill_manual(aesthetics = "fill", values = c('#a6cee3','#1f78b4','#b2df8a','#33a02c','#fb9a99','#e31a1c','#fdbf6f','#ff7f00'), name="Bird behavior")+ ggtitle("Primavera")
