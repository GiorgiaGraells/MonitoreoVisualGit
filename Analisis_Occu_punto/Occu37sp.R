...
Todos <-read_csv("Resumen_ocuInv_buffer.csv")
...
ggplot(Todos, aes(x=Distancia, y=Estimador, group=Especies)) + geom_line(aes(color=Origen)) + facet_wrap(~Parametro, scales = "free")
