...
data_reg <-data_reg %>% dplyr::select(starts_with("BLANQUILLO"), starts_with("CHERCAN"),starts_with("CHINCOL"), starts_with("CHURRETE_CHICO"), 
                                                           ...
                                                           starts_with("GOLONDRINA_DORSO_NEGRO"),  starts_with("GORRION"),  starts_with("GUANAY"),  starts_with("HUAIRAVO"),starts_with("JOTE_NEGRO"), 
...
OccuInv37_AMB <- batchoccu2(pres = data_reg, sitecov = data_ocu, obscov = data_det, spp=37 , form= "~Presencia_perros+ Temperatura +Humedad+ DirViento +RapViento+ Agua+ Presencia_otros+ Presencia_pescadores ~ AMBIENTE + CobVeg + Distancia_Costa + Altura + Distancia_construccion + Distancia_camino", dredge=TRUE,  SppNames = c("BLANQUILLO", "CHERCAN", "CHINCOL",  "CHURRETE_CHICO", "CHURRETE_COMUN", "CHURRETE_COSTERO", "COLEGIAL", "CORMORAN", "COTORRA_ARGENTINA","DIUCA", "GAVIOTA_FRANKLIN","GAVIOTA_GARUMA", "GAVIOTA", "GOLONDRINA_CHILENA",  "GOLONDRINA_DORSO_NEGRO",  "GORRION",  "GUANAY",  "HUAIRAVO",  "JOTE_CABEZA_NEGRA", "JOTE_CABEZA_ROJA", "LILE",  "MIRLO", "GAVIOTIN_MONJA",  "PALOMA", "PELICANO", "PERRITO",   "PILPILEN", "PILPILEN_NEGRO", "PIQUERO", "QUELTEHUE",  "RARA",   "TAGUA_COMUN", "TENCA",  "TIUQUE",  "TORDO",   "TORTOLA",  "ZORZAL" ))
...
OccuInv37_30 <- batchoccu2(pres = data_reg, sitecov = data_ocu, obscov = data_det, spp=37 , form= "~Presencia_perros+ Temperatura +Humedad+ DirViento +RapViento+ Agua+ Presencia_otros+ Presencia_pescadores ~ Buffer_30_Pastizales+Buffer_30_Matorrales+ Buffer_30_Sup_impermeables+ Buffer_30_Oceano+ Buffer_30_Suelo_arenoso+Buffer_30_Rocas+ Buffer_30_Grava", dredge=TRUE,  SppNames = c("BLANQUILLO", "CHERCAN", "CHINCOL",  "CHURRETE_CHICO", "CHURRETE_COMUN", "CHURRETE_COSTERO", "COLEGIAL", "CORMORAN", "COTORRA_ARGENTINA","DIUCA", "GAVIOTA_FRANKLIN","GAVIOTA_GARUMA", "GAVIOTA", "GOLONDRINA_CHILENA",  "GOLONDRINA_DORSO_NEGRO",  "GORRION",  "GUANAY",  "HUAIRAVO",  "JOTE_CABEZA_NEGRA", "JOTE_CABEZA_ROJA", "LILE",  "MIRLO", "GAVIOTIN_MONJA",  "PALOMA", "PELICANO", "PERRITO",   "PILPILEN", "PILPILEN_NEGRO", "PIQUERO", "QUELTEHUE",  "RARA",   "TAGUA_COMUN", "TENCA",  "TIUQUE",  "TORDO",   "TORTOLA",  "ZORZAL" ))
