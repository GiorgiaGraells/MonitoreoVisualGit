...
*Larosterna inca* shows similar ocurrence in both seasons, however during the spring it expand a little to the inland in some specific parts of the study area. The ocurrence is determine  




*Columba livia* . During the winter its presence is focussed in certain coastal areas, defined by the presence of sand (mapa y modelo). During the spring, its presence is high in almost the whole study area with exception of some small areas. According to the model selected, the presence of native forest and sand, and the ausence of grave and tree plantation allow this pattern.
...
Coastal urban environment studied present specific assembles of birds and they are determined mostly by variables such as altitude and ocean surface surrounding that areas. From the species ocurrence in those, there are strictly marine species and some can move to inland environments. Most of the terrestrial species are less strict and they manage to get closer to the ocean, specifically in areas with native vegetation such as natural beaches and natural rocky shore (with hay percentage of shrubs and native forrest).
