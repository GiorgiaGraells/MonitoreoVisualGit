...
I. 
M.
R.Six environments present specific assembles and they are determined mostly by variables such as altitude and percentage of the ocean in the areas. From the species ocurrence in those, there are strictly marine species and some can move to inland environments. Most of the terrestrial species are less strict and they manage to get closer to the ocean, specifically in areas with native vegetation such as natural beaches and natural rocky shore (with hay percentage of shrubs and native forrest).
D-C. Elements of urbanization and closeness to the coast are important factors on bird assemblages
...
2. Caracterize differences among those bird assembles, and
...
We studied coastal urban diversity of birds in the Graeter Valparaíso, determined assembles in different environments, relationships with environmental conditions and occupancy of key bird species.
...
This study gives information about not only bird species richness found in coastal urban habitats, also describe species identity in terms of assembles adapted in specific conditions within the city and bird ocurrence in continuos conditions 
