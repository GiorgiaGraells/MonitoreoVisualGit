...
Urbanization has been growing rapidly. During 2018, more than half of world’s population lived in urban settlements with cities growing in both size and number [@UN_WorldCities2018].

[Provide general background information]

Urbanization is a complex process that causes profound changes in the ecological functioning of the landscapeand gradually results in a changing spatial structure [@antrop2000changing] being one of the mayor causes of species loss [@czech2000economic].


[Establish the importance of this research topic, more specific/detailed way]

In this environment, some of these loss of native species have promoted the replacement by non-native species [@mckinney2006urbanization] because few species can adapt better to urban and suburban conditions [@mckinney1999biotic], affecting at ecosystemic level [grassland: @zeeman2017biotic], biomes [temperate: @zeeman2017biotic], and taxonomic groups [insects: @knop2016biotic, but mainly studies in birds and plants].
...
names(Especies) <- c("Columba livia", "Coragyps atratus", "Larosterna inca","Larus dominicanus", "Leucophaeus modestus", "Pelecanus thagus", "Turdus falcklandii", "Sephanoides sephaniodes")
...
```{r Comportamineto, fig.height=7, fig.width=10}
