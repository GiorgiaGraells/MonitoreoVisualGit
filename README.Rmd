...
Ocupancia con ambiente como variable forzada. El codigo está listo para la primavera, falta invierno. Se obtienen dos resultados: para cada ambiente (considerando el promedio de cada variable para cada ambiente) y para cada sitio considerando el valor de cada variable
